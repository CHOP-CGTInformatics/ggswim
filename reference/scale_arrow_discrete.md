...
- colours:
  ...
  Arrow outline colours passed to the arrow layer.

- fills:

  Arrow fill colours passed to the arrow layer for closed arrows.

- types:

  Arrow head types passed to the arrow layer. One of `"open"` or
  `"closed"`.

- limits:

  Arrow labels passed to the arrow scale.
