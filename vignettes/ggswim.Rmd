...
Let's get started building our swimmer plot! As with the [README](https://chop-cgtinformatics.github.io/ggswim/index.html), we will be using ggswim's internal datasets: `patient_data`, `infusion_events`, and `end_study_events`. 
...
- ggswim supports use of FontAwesome icons for glyph definition in addition to shapes and emojis. Check out the [**Gallery**](https://chop-cgtinformatics.github.io/ggswim/articles/gallery.html) for examples on how to add them to your plots!
