...
At present, a little bit of some data manipulation is required to get `patient_status` from a typically expected structure to one that is ready for swimming:
