...
To start, let's build a swimmer plot using `aes()` and aesthetic mapped data (for fixed mapping, see [Fixed Marker Mapping](https://chop-cgtinformatics.github.io/ggswim/articles/fixed_markers.html)). As with the README, we will be using ggswim's internal datasets: `patient_data`, `infusion_events`, and `end_study_events`. 
