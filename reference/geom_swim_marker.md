# Add markers to swimmer plots

Markers are specific symbols or indicators placed on the lanes of a
swimmer plot to denote particular events, milestones, or statuses. They
provide additional contextual information about significant occurrences
during the timeline, such as treatment responses or adverse events.
...
ggswim enables the following `family` arguments:
