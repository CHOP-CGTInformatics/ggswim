...
While it is often common to see these datasets as separate components in
the wild, we’ll make our lives a little easier during plotting by
...
![Updated swimmer plot with event markers applied using
scale_marker_discrete.](reference/figures/README-unnamed-chunk-4-1.png)

Using the custom `marker`
[`aes()`](https://ggplot2.tidyverse.org/reference/aes.html) in
[`geom_swim_marker()`](https://chop-cgtinformatics.github.io/ggswim/reference/geom_swim_marker.md)
in combination with specific scale definitions helps us keep the markers
and lanes separate in the legend. Finally, we’ll beautify the plot with
familiar ggplot2 techniques and a last finishing touch with
