...
geom_swim_marquee <- function(mapping = NULL, data = NULL,
  ...
  # and color overwriting in the setup_data portion of GeomSwimMarquee
  ...
  class(layer_obj) <- c("swim_marquee", class(layer_obj))
...
#' @export
ggplot_add.swim_marquee <- function(object, plot, object_name) {
...
#' @rdname geom_swim_marquee
#' @format NULL
#' @usage NULL
#' @export
GeomSwimMarquee <- ggproto("GeomSwimMarquee", GeomMarquee,
                           required_aes = c("x", "y", "label"),
