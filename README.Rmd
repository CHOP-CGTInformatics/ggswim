...
ggswim helps create stunning swimmer plots by integrating with the familiar ggplot2 framework, allowing developers to effortlessly add layers and customize displays to their needs.

ggswim streamlines the process of generating legends that clearly communicate layer data of added complexity when combining fill, point, and label layer types.
...
Let's load the data and dive into creating our swimmer plots! The first step is to create a variant of a `geom_col()` using the `ggswim()` function. This makes the swimmer plot "lanes":
...
And finally, we'll spruce up our plot a bit to make it more aesthetically appealing:
