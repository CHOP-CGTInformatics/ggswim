...
- Missing data in a layer followed by a layer with complete data will remove the missing data from the legend
- The legend title for one-at-a-time markers defaults to the first value in the legend
